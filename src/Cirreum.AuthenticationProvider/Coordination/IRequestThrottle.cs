...
/// <summary>
/// Fixed-window rate-limit primitive — consumed by the ApiKey scheme's <c>SelfContained</c> conformance
/// profile (ADR-0020). Backed by any store with an atomic counter + expiry: the built-in single-instance
/// <see cref="InMemoryRequestThrottle"/>, or a distributed adapter
